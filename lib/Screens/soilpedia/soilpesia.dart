...
import 'Solipedia_detail_page.dart';
import 'soilpedia_Card_list.dart';
...
class SoilCard extends StatelessWidget {
  ...
  List<Detail> details = [
    Detail(
        ...
        found:
            'Most of the delta areas of North Pakistan. It covers over 35% of total Pakistan land.',
        character:
    ...
    Detail(
        ...
        found:
            'Multan. This includes Sindh Proience, KPK. This soil type is prominent in river valley of rivers Punjab, KPK, Sindh, and Baclotistan.',
        character:
    ...
    Detail(
        ...
        found: 'western Balochistan, Thal, Thar, and the Cholistan Desert.',
        character:
    ...
    Detail(
        ...
        found: 'Himalayan area, Western and Eastern Pakistan.',
        character:
    ...
    Detail(
        ...
        found: 'Hyderabad, Sahiwal, Multan, Badin, and Indus Delta.',
        character:
